...
@njit
def _fillrho2(A1_r_equator, V_e, A1_r_pole, V_p, P_c, P_i, P_s, rho_c, rho_s,
...
def spin2layer(num_attempt, A1_r_equator, A1_rho_equator,
    ...
    for i in tqdm(range(num_attempt), desc="Solving spining profile", disable = (not verbose>=1)):
        V_e, V_p = L1_spin._fillV(A1_r_equator, A1_rho_equator,
                                  A1_r_pole, A1_rho_pole, Tw)
        A1_rho_equator, A1_rho_pole = _fillrho2(A1_r_equator, V_e,
                                A1_r_pole, V_p, P_c, P_i, P_s, rho_c, rho_s,
                                mat_id_L1, T_rho_type_id_L1, T_rho_args_L1,
                                mat_id_L2, T_rho_type_id_L2, T_rho_args_L2)
        profile_e.append(A1_rho_equator)
        profile_p.append(A1_rho_pole)
...
def picle_placement_L2(A1_r_equator, A1_rho_equator, A1_r_pole, A1_rho_pole,
                       Tw, N, rho_i,
                       mat_id_L1, T_rho_type_id_L1, T_rho_args_L1,
                       mat_id_L2, T_rho_type_id_L2, T_rho_args_L2,
                       N_neig=48):
