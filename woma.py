...
def L1_integrate(num_prof, R, M, P_s, T_s, rho_s, mat_id, T_rho_type,
    ...
    T_rho_args  = weos.set_T_rho_args(T_s, rho_s, T_rho_type, T_rho_args,
                                      mat_id)
    ...
    for i in range(1, A1_r.shape[0]):
        ...
        # Layer 1, 2 boundary
            ...
            rho = weos._find_rho_fixed_P_T(A1_P[i - 1], A1_T[i - 1], mat_id_L1,
                                           u_cold_array_L1)
            T_rho_args_L1  = weos.set_T_rho_args(
...
def L3_integrate(
    ...
    T_rho_args_L3   = weos.set_T_rho_args(T_s, rho_s, T_rho_type_L3,
    ...
    for i in range(1, A1_r.shape[0]):
        ...
        # Layer 2, 3 boundary
            ...
            rho = weos._find_rho_fixed_P_T(A1_P[i - 1], A1_T[i - 1], mat_id_L2,
                                           u_cold_array_L2)
            T_rho_args_L2   = weos.set_T_rho_args(
...
class Planet():
    ...
    def gen_prof_L3_fix_R1_R2_given_M1_M2_add_L3(
        ...
        self.rho_s              = weos.find_rho_fixed_P_T(
