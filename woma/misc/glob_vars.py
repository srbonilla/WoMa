...
Di_mat_id = {
    ...
    "Til_ice": Di_mat_type["Til"] * type_factor + 4,
    ...
    "CMS19_HHe": Di_mat_type["SESAME"] * type_factor + 7,  # H/He mixture Y=0.245
    "SCVH95_HHe": Di_mat_type["SESAME"] * type_factor + 8,  # Saumon+1995 Y=0.245
    "REOS3_HHe": Di_mat_type["SESAME"] * type_factor + 9,  # Becker+2014 Y=0.245
    # ANEOS
...
id_SCVH95_HHe = Di_mat_id["SCVH95_HHe"]
id_REOS3_HHe = Di_mat_id["REOS3_HHe"]
...
Fp_u_cold_Til_ice = dir_data + "u_cold_array_Til_ice.npy"
# HM80 tables
...
Fp_SCVH95_HHe = dir_data + "SCVH95_HHe.txt"
Fp_REOS3_HHe = dir_data + "REOS3_HHe.txt"
# ANEOS tables
