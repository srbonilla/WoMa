...
from woma.misc.glob_vars import type_factor, Di_mat_type, Di_mat_id, Di_id_mat, Di_T_rho_id
...
from woma.eos.eos import P_u_rho, u_rho_T, P_T_rho, s_rho_T, rho_P_T
