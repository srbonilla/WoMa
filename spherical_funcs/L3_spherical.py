...
def L3_integrate(
    ...
    T_rho_args_L3   = set_T_rho_args(T_s, rho_s, T_rho_type_L3,
    ...
    for i in range(1, A1_r.shape[0]):
        ...
        # Layer 2, 3 boundary
            ...
            T_rho_args_L2   = set_T_rho_args(
                A1_T[i - 1], rho, T_rho_type_L2, T_rho_args_L2, mat_id_L2)
            mat_id          = mat_id_L2
...
def L3_find_radius(
    ...
    T_rho_args_L1, mat_id_L2, T_rho_type_L2, T_rho_args_L2, mat_id_L3,
    T_rho_type_L3, T_rho_args_L3, num_attempt=40
    ):
    """ Finder of the total mass of the planet.
        The correct value yields A1_m_enc -> 0 at the center of the planet.
...
def L3_find_R2(
    ...
    A1_r, A1_m_enc, A1_P, A1_T, A1_rho, A1_u, A1_mat_id = L2_spherical.L2_integrate(
        num_prof, R, M, P_s, T_s, rho_s, R1, mat_id_L1, T_rho_type_L1,
        T_rho_args_L1, mat_id_L3, T_rho_type_L3, T_rho_args_L3
        )
...
def L3_find_R1_R2(
    ...
    T_rho_args_L1, mat_id_L2, T_rho_type_L2, T_rho_args_L2, mat_id_L3,
    T_rho_type_L3, T_rho_args_L3, num_attempt=20, num_attempt_2=10
    ):
